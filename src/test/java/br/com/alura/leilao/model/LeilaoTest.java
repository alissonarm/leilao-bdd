...
public class LeilaoTest {
	...
	@Nested
	@DisplayName("Dado uma lance valido")
	class UnicoLanceTests {
		...
		@Nested
		@DisplayName("Qaundo propoe o lance")
...
//				leilao.propoe(new Usuario("Steve Jobs"), doisMil));
				leilao.propoe(new Lance(new Usuario("John Doe"), BigDecimal.ZERO));
